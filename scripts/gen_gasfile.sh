#!/bin/bash
if [ $# -lt 7 -o $# -gt 9 ];then
    echo "Usage : source gen_gasfile <arg1> <arg2> <arg3> <arg4> <arg5> <arg6> <arg7> [<arg8> <arg9>]"
    echo "Arguments list : "
    ...
    echo "Optional"
    echo "  <arg8> : Penning transfer probability"
    echo "  <arg9> : Mean free path of transfer"
